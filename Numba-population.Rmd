...
The table above shows the organization collecting numbat sightings and the completeness of their collected information in regards to the table properties. There are 18 organization that contributed to this numbat sightings only one organization, Earth Guardians Weekly Feed	achieved 100% data completeness, following close to 97 %completeness is iNaturalist Australia. 
...
The data shows that three geographic locations in Australia have the most sightings. The largest cluster of sightings is in southwest Australia near the city of Perth. The next location, though substantially smaller, is near the city of Alice Springs, and the last is near the city of Adelaide.
...
The geographic map and accompanying table illustrate the distribution of numbat sightings over time. Note that the  number of red points represents no time stamp information in this map. No time stamp sighting consist of roughly 31% of the total data as revealed in the data exploration. The map shows most of the SW Australia sighting location cluster do not have time data. Alice Springs is the second major area with a significant number of sightings lacking time information. 

Interestingly, the map reveals that sightings of the numbat subspecies, Myrmecobius fasciatus rufus, are confined primarily to Alice Springs, with a few occurrences near Adelaide. A noteworthy detail is  the timestamped sighting of the Myrmecobius fasciatus rufus variant near Adelaide goes back to 1856, with subsequent sightings lacking times tamp as well.
...
Focusing on the table above, it highlights the sightings in SW Australia. The table shows that 70% of sightings in that region lack a timestamp. It also indicates an increasing trend in recorded sightings over time, particularly from 2019 onwards, when data collection efforts were enhanced to include timestamps for sightings.
...
The table above illustrates that data collection in the region has been consistent from 2008 to the present, although there was a notable decrease to just one sighting in 2015. Remarkably, there was only one sighting of the variant M. fasciatus rufus in 1856; all other sightings pertain to M. fasciatus. Additionally, three sightings lack timestamps
...
```
In central Australia near Alice Springs, there are 15 sightings recorded with no time stamp information Interesting enough the variant M. fasciatus rufus is predominantly seen in this region. 
...
In regards to weather, the numbats have mostly been seen around 60 to 70 F in days that are the hottest. Days when it the coolest numbats are mostly seen around 40 to 50 F. This shows that numbats prefer to be in hiding during the hottest times of the day or prefer more temperate environment.
